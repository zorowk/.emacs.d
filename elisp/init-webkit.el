;;; init-webkit.el --- -*- lexical-binding: t -*-
;;
;; Filename: init-webkit.el
;; Description: Initialize Emacs Webkit
;; Author: zorowk
...
;; webkit
(use-package webkit
  :load-path (lambda () (expand-file-name "site-elisp/emacs-webkit" user-emacs-directory))
  :init
